...
#define STRING_CONFIG_H_AUTHOR "(Reimnop, TinkerBox)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "TinkerBox"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 696.56 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -25, 0, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define HOMING_FEEDRATE_MM_M { (30*60), (30*60), (20*60) }
