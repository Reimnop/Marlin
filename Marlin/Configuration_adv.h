...
/**
 * Don't re-initialize the LCD after certain operations
 * This can help with freezing issues during UI navigation, but may require a full restart if LCD dies
 */
#define DONT_REINIT_LCD
